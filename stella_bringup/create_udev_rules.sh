...
echo "/home/odroid/colcon_ws/src/STELLA_N1_ODROID_N2_X4_ROS2_v2.0/stella_bringup/stella.rules"
sudo cp /home/odroid/colcon_ws/src/STELLA_N1_ODROID_N2_X4_ROS2_v2.0/stella_bringup/stella.rules  /etc/udev/rules.d
echo " "
